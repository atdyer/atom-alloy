...
export default class MainView {
    ...
    constructor(selection) {
        ...
        this.settings = this.div.append('atom-panel')
            .attr('class', 'modal')
            .style('display', 'none');
    ...
    toggleSettings() {
        ...
        let is_hidden = this.settings.style('display') === 'none';
        let toggle = this.toggleSettings.bind(this);

        this.settings.style('display', is_hidden ? null : 'none');
        this.div.select('atom-panel.modal')
            .on('click', function () {
    ...
    _showKeymaps(is_displayed) {
        ...
        this.commands.select('.key-bindings')
