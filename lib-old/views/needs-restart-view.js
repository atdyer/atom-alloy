...
export default function needs_restart_view (selection) {
    ...
    _needs_restart_view.show = function () {
    ...
    _needs_restart_view.display_error = function () {
    ...
    _needs_restart_view.display_warning = function (on_return_callback) {

        _warning_callback = function () {
            on_return_callback();
            _warning_callback = null;
        };
